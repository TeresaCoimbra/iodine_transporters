...
def domains_to_df(domains_list):
    ...
    for dom in domains_list:  # dom is a dictionary with domain information
        ...
        mfs_dms = ['CDD:273530','CDD:215595','CDD:188098',
                   'CDD:350042','CDD:365789','CDD:213211',
                   'CDD:350047','CDD:350022','CDD:213217']
    ...
    if "Taxus" in df.Source[0]:
        ...
        try:
            df_new = df.iloc[np.where(
                df.Accession.isin(df_dms.Accession))]  # cria novo df com as accessions que contém dominios de interesse
